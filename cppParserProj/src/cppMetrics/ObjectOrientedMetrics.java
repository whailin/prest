...
public class ObjectOrientedMetrics implements Metrics
{
	...
	/**
	 * RFC is calculated with sum of number of methods in the class and number
	 * of different methods that are called in, but are not from the class which
	 * RFC is calculated.
	 */
	...
	/**
	 * LCOM is a number of method pairs with no similarity,|P|, minus number of
	 * methods,|Q|. Method pairs are considered to be non-similar if they dont
	 * use a single same instance variable. LCOM = |P| - |Q|, when |P|>|Q|,
	 * otherwise LCOM=0.
	 * 
	 * @param nonSimilarMethods
	 *            P
	 * @param similarMethods
	 *            Q
	 * @return
	 */
