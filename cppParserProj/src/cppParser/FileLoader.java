...
public class FileLoader {
	 ...
	 * @param path A path to a file or a folder
	 */
	...
	/**
	 * Sorts the given list of files so that header files are before
	 * the source files
	 * @param files The list of files to sort
	 * @return A sorted list where header files are first before the source files
	 */
