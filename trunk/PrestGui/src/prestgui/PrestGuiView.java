...
public class PrestGuiView extends FrameView {
	...
	private void initComponents() {
		...
		javax.swing.JMenuItem documentationMenuItem = new javax.swing.JMenuItem();
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				.getInstance(prestgui.PrestGuiApp.class).getContext()
				.getResourceMap(PrestGuiView.class);
		...
		toolbarPanelLayout.setHorizontalGroup(toolbarPanelLayout
				...
				.addGroup(
						toolbarPanelLayout.createSequentialGroup()
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application
				.getInstance(prestgui.PrestGuiApp.class).getContext()
				.getActionMap(PrestGuiView.class, this);
		...
		btnLoadCategorizer.setText(resourceMap
				.getString("btnLoadCategorizer.text")); // NOI18N
		...
		btnStoreCategorizer.setText(resourceMap
				.getString("btnStoreCategorizer.text")); // NOI18N
		btnStoreCategorizer.setName("btnStoreCategorizer"); // NOI18N
		btnStoreCategorizer.setVisible(false);

		javax.swing.GroupLayout pnlCategorizeButtonsLayout = new javax.swing.GroupLayout(
				pnlCategorizeButtons);
		pnlCategorizeButtons.setLayout(pnlCategorizeButtonsLayout);
		pnlCategorizeButtonsLayout
				.setHorizontalGroup(pnlCategorizeButtonsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlCategorizeButtonsLayout
										.createSequentialGroup().addGap(17, 17,
												17).addComponent(
												btnLoadCategorizer).addGap(28,
												28, 28).addComponent(
												btnCategorize).addGap(29, 29,
												29).addComponent(
												btnStoreCategorizer)
										.addContainerGap(66, Short.MAX_VALUE)));
		pnlCategorizeButtonsLayout
				.setVerticalGroup(pnlCategorizeButtonsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlCategorizeButtonsLayout
		...
		cmbMetricGroups.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "Package Metrics", "File Metrics",
		...
		javax.swing.GroupLayout packageMetricsDataSetPanelLayout = new javax.swing.GroupLayout(
				packageMetricsDataSetPanel);
		packageMetricsDataSetPanel.setLayout(packageMetricsDataSetPanelLayout);
		packageMetricsDataSetPanelLayout
				.setHorizontalGroup(packageMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		packageMetricsDataSetPanelLayout
				.setVerticalGroup(packageMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));

		packageMetricsTabbedPane
				.addTab(
						resourceMap
								.getString("packageMetricsDataSetPanel.TabConstraints.tabTitle"),
						packageMetricsDataSetPanel); // NOI18N

		packageMetricsThresholdPanel.setName("packageMetricsThresholdPanel"); // NOI18N

		javax.swing.GroupLayout packageMetricsThresholdPanelLayout = new javax.swing.GroupLayout(
				packageMetricsThresholdPanel);
		packageMetricsThresholdPanel
				.setLayout(packageMetricsThresholdPanelLayout);
		packageMetricsThresholdPanelLayout
				.setHorizontalGroup(packageMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		packageMetricsThresholdPanelLayout
				.setVerticalGroup(packageMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));
		...
		packageMetricsTabbedPane
				.addTab(
						resourceMap
								.getString("packageMetricsThresholdPanel.TabConstraints.tabTitle"),
						packageMetricsThresholdPanel); // NOI18N
		...
		javax.swing.GroupLayout fileMetricsDataSetPanelLayout = new javax.swing.GroupLayout(
				fileMetricsDataSetPanel);
		fileMetricsDataSetPanel.setLayout(fileMetricsDataSetPanelLayout);
		fileMetricsDataSetPanelLayout
				.setHorizontalGroup(fileMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		fileMetricsDataSetPanelLayout
				.setVerticalGroup(fileMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));

		fileMetricsTabbedPane.addTab(resourceMap
				.getString("fileMetricsDataSetPanel.TabConstraints.tabTitle"),
				fileMetricsDataSetPanel); // NOI18N

		fileMetricsThresholdPanel.setName("fileMetricsThresholdPanel"); // NOI18N

		javax.swing.GroupLayout fileMetricsThresholdPanelLayout = new javax.swing.GroupLayout(
				fileMetricsThresholdPanel);
		fileMetricsThresholdPanel.setLayout(fileMetricsThresholdPanelLayout);
		fileMetricsThresholdPanelLayout
				.setHorizontalGroup(fileMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		fileMetricsThresholdPanelLayout
				.setVerticalGroup(fileMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));

		fileMetricsTabbedPane
				.addTab(
						resourceMap
								.getString("fileMetricsThresholdPanel.TabConstraints.tabTitle"),
						fileMetricsThresholdPanel); // NOI18N
		...
		javax.swing.GroupLayout classMetricsDataSetPanelLayout = new javax.swing.GroupLayout(
				classMetricsDataSetPanel);
		classMetricsDataSetPanel.setLayout(classMetricsDataSetPanelLayout);
		classMetricsDataSetPanelLayout
				.setHorizontalGroup(classMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		classMetricsDataSetPanelLayout
				.setVerticalGroup(classMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));

		classMetricsTabbedPane.addTab(resourceMap
				.getString("classMetricsDataSetPanel.TabConstraints.tabTitle"),
				classMetricsDataSetPanel); // NOI18N

		classMetricsThresholdPanel.setName("classMetricsThresholdPanel"); // NOI18N

		javax.swing.GroupLayout classMetricsThresholdPanelLayout = new javax.swing.GroupLayout(
				classMetricsThresholdPanel);
		classMetricsThresholdPanel.setLayout(classMetricsThresholdPanelLayout);
		classMetricsThresholdPanelLayout
				.setHorizontalGroup(classMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		classMetricsThresholdPanelLayout
				.setVerticalGroup(classMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));

		classMetricsTabbedPane
				.addTab(
						resourceMap
								.getString("classMetricsThresholdPanel.TabConstraints.tabTitle"),
						classMetricsThresholdPanel); // NOI18N
		...
		javax.swing.GroupLayout methodMetricsDataSetPanelLayout = new javax.swing.GroupLayout(
				methodMetricsDataSetPanel);
		methodMetricsDataSetPanel.setLayout(methodMetricsDataSetPanelLayout);
		methodMetricsDataSetPanelLayout
				.setHorizontalGroup(methodMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		methodMetricsDataSetPanelLayout
				.setVerticalGroup(methodMetricsDataSetPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));

		methodMetricsTabbedPane
				.addTab(
						resourceMap
								.getString("methodMetricsDataSetPanel.TabConstraints.tabTitle"),
						methodMetricsDataSetPanel); // NOI18N

		methodMetricsThresholdPanel.setName("methodMetricsThresholdPanel"); // NOI18N

		javax.swing.GroupLayout methodMetricsThresholdPanelLayout = new javax.swing.GroupLayout(
				methodMetricsThresholdPanel);
		methodMetricsThresholdPanel
				.setLayout(methodMetricsThresholdPanelLayout);
		methodMetricsThresholdPanelLayout
				.setHorizontalGroup(methodMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 540, Short.MAX_VALUE));
		methodMetricsThresholdPanelLayout
				.setVerticalGroup(methodMetricsThresholdPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 253, Short.MAX_VALUE));
		...
		methodMetricsTabbedPane
				.addTab(
						resourceMap
								.getString("methodMetricsThresholdPanel.TabConstraints.tabTitle"),
						methodMetricsThresholdPanel); // NOI18N
		...
		javax.swing.GroupLayout pnlLanguageRadioPanelLayout = new javax.swing.GroupLayout(
				pnlLanguageRadioPanel);
		pnlLanguageRadioPanel.setLayout(pnlLanguageRadioPanelLayout);
		pnlLanguageRadioPanelLayout
				.setHorizontalGroup(pnlLanguageRadioPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 437, Short.MAX_VALUE));
		pnlLanguageRadioPanelLayout
				.setVerticalGroup(pnlLanguageRadioPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGap(0, 20, Short.MAX_VALUE));

		javax.swing.GroupLayout pnlParseResultsAnalyzeLayout = new javax.swing.GroupLayout(
				pnlParseResultsAnalyze);
		pnlParseResultsAnalyze.setLayout(pnlParseResultsAnalyzeLayout);
		pnlParseResultsAnalyzeLayout
				.setHorizontalGroup(pnlParseResultsAnalyzeLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlParseResultsAnalyzeLayout
										...
										.addContainerGap()));
		pnlParseResultsAnalyzeLayout
				.setVerticalGroup(pnlParseResultsAnalyzeLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlParseResultsAnalyzeLayout
		...
		javax.swing.GroupLayout pnlDataFileLayout = new javax.swing.GroupLayout(
				pnlDataFile);
		pnlDataFile.setLayout(pnlDataFileLayout);
		pnlDataFileLayout.setHorizontalGroup(pnlDataFileLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						pnlDataFileLayout.createSequentialGroup()
								.addContainerGap().addComponent(jLabel23)
								.addContainerGap(431, Short.MAX_VALUE)));
		pnlDataFileLayout.setVerticalGroup(pnlDataFileLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						pnlDataFileLayout.createSequentialGroup()
								.addContainerGap().addComponent(jLabel23)
		...
		tabPaneDataFileAnalyze.addTab(resourceMap
				.getString("pnlDataFile.TabConstraints.tabTitle"), pnlDataFile); // NOI18N

		javax.swing.GroupLayout pnlDataFileAnalyzeLayout = new javax.swing.GroupLayout(
				pnlDataFileAnalyze);
		pnlDataFileAnalyze.setLayout(pnlDataFileAnalyzeLayout);
		pnlDataFileAnalyzeLayout.setHorizontalGroup(pnlDataFileAnalyzeLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(tabPaneDataFileAnalyze,
						javax.swing.GroupLayout.DEFAULT_SIZE, 565,
						Short.MAX_VALUE));
		pnlDataFileAnalyzeLayout.setVerticalGroup(pnlDataFileAnalyzeLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(tabPaneDataFileAnalyze,
		...
		javax.swing.GroupLayout pnlDataTabLayout = new javax.swing.GroupLayout(
				pnlDataTab);
		pnlDataTab.setLayout(pnlDataTabLayout);
		pnlDataTabLayout
				.setHorizontalGroup(pnlDataTabLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								pnlDataTabLayout
										...
										.addContainerGap()));
		pnlDataTabLayout
				.setVerticalGroup(pnlDataTabLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlDataTabLayout
		...
		tabPaneAnalysisResults.addTab(resourceMap
				.getString("pnlDataTab.TabConstraints.tabTitle"), pnlDataTab); // NOI18N

		pnlClassifyTab.setName("pnlClassifyTab"); // NOI18N

		testOptionsPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(resourceMap
						.getString("testOptionsPanel.border.title"))); // NOI18N
		...
		rbtnSuppliedTestSet.setText(resourceMap
				.getString("rbtnSuppliedTestSet.text")); // NOI18N
		...
		rbtnCrossValidation.setText(resourceMap
				.getString("rbtnCrossValidation.text")); // NOI18N
		...
		percentageSplitRadioButton.setText(resourceMap
				.getString("percentageSplitRadioButton.text")); // NOI18N
		percentageSplitRadioButton.setName("percentageSplitRadioButton"); // NOI18N
		percentageSplitRadioButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		txtCrossValidation.setText(resourceMap
				.getString("txtCrossValidation.text")); // NOI18N
		txtCrossValidation.setEnabled(false);
		txtCrossValidation.setName("txtCrossValidation"); // NOI18N

		txtPercentageSplit.setText(resourceMap
				.getString("txtPercentageSplit.text")); // NOI18N
		...
		lblCassifierName
				.setText(resourceMap.getString("lblCassifierName.text")); // NOI18N
		lblCassifierName.setName("lblCassifierName"); // NOI18N
		lblCassifierName.setText("");

		javax.swing.GroupLayout testOptionsPanelLayout = new javax.swing.GroupLayout(
				testOptionsPanel);
		testOptionsPanel.setLayout(testOptionsPanelLayout);
		testOptionsPanelLayout
				.setHorizontalGroup(testOptionsPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								testOptionsPanelLayout
		...
		testOptionsPanelLayout
				.setVerticalGroup(testOptionsPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
		...
		classifierOutputPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(resourceMap
						.getString("classifierOutputPanel.border.title"))); // NOI18N
		...
		javax.swing.GroupLayout classifierOutputPanelLayout = new javax.swing.GroupLayout(
				classifierOutputPanel);
		classifierOutputPanel.setLayout(classifierOutputPanelLayout);
		classifierOutputPanelLayout
				.setHorizontalGroup(classifierOutputPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(outputTextAreaScrollPane,
								javax.swing.GroupLayout.DEFAULT_SIZE, 331,
								Short.MAX_VALUE));
		classifierOutputPanelLayout
				.setVerticalGroup(classifierOutputPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(outputTextAreaScrollPane,
		...
		classifyStartButton.setText(resourceMap
				.getString("classifyStartButton.text")); // NOI18N
		...
		javax.swing.GroupLayout pnlClassifyTabLayout = new javax.swing.GroupLayout(
				pnlClassifyTab);
		pnlClassifyTab.setLayout(pnlClassifyTabLayout);
		pnlClassifyTabLayout
				.setHorizontalGroup(pnlClassifyTabLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlClassifyTabLayout
										...
										.addContainerGap()));
		pnlClassifyTabLayout
				.setVerticalGroup(pnlClassifyTabLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlClassifyTabLayout
		...
		tabPaneAnalysisResults.addTab(resourceMap
				.getString("pnlClassifyTab.TabConstraints.tabTitle"),
				pnlClassifyTab); // NOI18N
		tabPaneAnalysisResults.setSelectedIndex(0);

		javax.swing.GroupLayout analysisResultsPanelLayout = new javax.swing.GroupLayout(
				analysisResultsPanel);
		analysisResultsPanel.setLayout(analysisResultsPanelLayout);
		analysisResultsPanelLayout
				.setHorizontalGroup(analysisResultsPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								analysisResultsPanelLayout
										...
										.addContainerGap()
										.addComponent(
												tabPaneAnalysisResults,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												590, Short.MAX_VALUE)
										.addContainerGap()));
		analysisResultsPanelLayout
				.setVerticalGroup(analysisResultsPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								analysisResultsPanelLayout
		...
		mainPanelLayout.setHorizontalGroup(mainPanelLayout.createParallelGroup(
				...
				toolbarPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		addProjectMenuItem.setText(resourceMap
				.getString("addProjectMenuItem.text")); // NOI18N
		...
		switchWorkspaceMenuItem.setText(resourceMap
				.getString("switchWorkspaceMenuItem.text")); // NOI18N
		...
		thresholdMenuItem.setText(resourceMap
				.getString("thresholdMenuItem.text")); // NOI18N
		...
		virtualMetricMenuItem.setText(resourceMap
				.getString("virtualMetricMenuItem.text")); // NOI18N
		...
		//documentationMenuItem.setAction(actionMap.get("http://www.google.com")
		// );
		documentationMenuItem.setName("Documentation"); // NOI18N
		...
		virtualMetricWizardDialog.setTitle(resourceMap
				.getString("virtualMetricWizardDialog.title")); // NOI18N
		...
		javax.swing.GroupLayout pnlVmHeaderLayout = new javax.swing.GroupLayout(
				pnlVmHeader);
		pnlVmHeader.setLayout(pnlVmHeaderLayout);
		pnlVmHeaderLayout.setHorizontalGroup(pnlVmHeaderLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						pnlVmHeaderLayout.createSequentialGroup()
								.addContainerGap().addComponent(jLabel19)
								.addContainerGap(267, Short.MAX_VALUE)));
		pnlVmHeaderLayout.setVerticalGroup(pnlVmHeaderLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						pnlVmHeaderLayout.createSequentialGroup()
								.addContainerGap(
										javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE).addComponent(jLabel19)
								.addContainerGap()));

		pnlVmCardLayout.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		...
		rbtnVmOperand1Txt.setText(resourceMap
				.getString("rbtnVmOperand1Txt.text")); // NOI18N
		...
		rbtnVmOperand1Cmb.setText(resourceMap
				.getString("rbtnVmOperand1Cmb.text")); // NOI18N
		...
		rbtnVmOperand2Txt.setText(resourceMap
				.getString("rbtnVmOperand2Txt.text")); // NOI18N
		...
		rbtnVmOperand2Cmb.setText(resourceMap
				.getString("rbtnVmOperand2Cmb.text")); // NOI18N
		...
		javax.swing.GroupLayout pnlVmSettingsLayout = new javax.swing.GroupLayout(
				pnlVmSettings);
		pnlVmSettings.setLayout(pnlVmSettingsLayout);
		pnlVmSettingsLayout
				.setHorizontalGroup(pnlVmSettingsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlVmSettingsLayout
										...
										.addContainerGap()));
		pnlVmSettingsLayout
				.setVerticalGroup(pnlVmSettingsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlVmSettingsLayout
		...
		lblVirtualMetricName.setFont(resourceMap
				.getFont("lblVirtualMetricName.font")); // NOI18N
		lblVirtualMetricName.setText(resourceMap
				.getString("lblVirtualMetricName.text")); // NOI18N
		lblVirtualMetricName.setName("lblVirtualMetricName"); // NOI18N

		lblVirtualMetricEquation.setFont(resourceMap
				.getFont("lblVirtualMetricEquation.font")); // NOI18N
		lblVirtualMetricEquation.setText(resourceMap
				.getString("lblVirtualMetricEquation.text")); // NOI18N
		lblVirtualMetricEquation.setName("lblVirtualMetricEquation"); // NOI18N

		javax.swing.GroupLayout pnlVmApprovalLayout = new javax.swing.GroupLayout(
				pnlVmApproval);
		pnlVmApproval.setLayout(pnlVmApprovalLayout);
		pnlVmApprovalLayout
				.setHorizontalGroup(pnlVmApprovalLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlVmApprovalLayout
																		...
																		.addGroup(
																				pnlVmApprovalLayout
																						.createParallelGroup(
																								javax.swing.GroupLayout.Alignment.LEADING)
																						.addComponent(
																								lblVirtualMetricName,
																								javax.swing.GroupLayout.DEFAULT_SIZE,
																								294,
																								Short.MAX_VALUE)
																						.addComponent(
																								lblVirtualMetricEquation,
																								javax.swing.GroupLayout.DEFAULT_SIZE,
																								294,
																								Short.MAX_VALUE))))
										.addContainerGap()));
		pnlVmApprovalLayout
				.setVerticalGroup(pnlVmApprovalLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlVmApprovalLayout
		...
		cancelVirtualMetricButton.setAction(actionMap
				.get("closeVirtualMetricDialog")); // NOI18N
		cancelVirtualMetricButton.setText(resourceMap
				.getString("cancelVirtualMetricButton.text")); // NOI18N
		...
		javax.swing.GroupLayout pnlVmButtonsLayout = new javax.swing.GroupLayout(
				pnlVmButtons);
		pnlVmButtons.setLayout(pnlVmButtonsLayout);
		pnlVmButtonsLayout
				.setHorizontalGroup(pnlVmButtonsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								pnlVmButtonsLayout
										...
										.addPreferredGap(
												javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(btnVmNext).addGap(26, 26,
												26).addComponent(
												cancelVirtualMetricButton)
										.addContainerGap()));
		pnlVmButtonsLayout
				.setVerticalGroup(pnlVmButtonsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlVmButtonsLayout
		...
		javax.swing.GroupLayout virtualMetricWizardDialogLayout = new javax.swing.GroupLayout(
				virtualMetricWizardDialog.getContentPane());
		virtualMetricWizardDialog.getContentPane().setLayout(
				virtualMetricWizardDialogLayout);
		virtualMetricWizardDialogLayout
				.setHorizontalGroup(virtualMetricWizardDialogLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								virtualMetricWizardDialogLayout
										...
										.addContainerGap()));
		virtualMetricWizardDialogLayout
				.setVerticalGroup(virtualMetricWizardDialogLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								virtualMetricWizardDialogLayout
		...
		thresholdWizardDialog.setTitle(resourceMap
				.getString("thresholdWizardDialog.title")); // NOI18N
		...
		pnlThresholdSettingsCardLayout.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		pnlThresholdSettingsCardLayout
				.setName("pnlThresholdSettingsCardLayout"); // NOI18N
		...
		cmbThresholdMetricList.setToolTipText(resourceMap
				.getString("cmbThresholdMetricList.toolTipText")); // NOI18N
		...
		rbtnThresholdOperatorOneTxt.setText(resourceMap
				.getString("rbtnThresholdOperatorOneTxt.text")); // NOI18N
		rbtnThresholdOperatorOneTxt.setName("rbtnThresholdOperatorOneTxt"); // NOI18N
		rbtnThresholdOperatorOneTxt
				.addChangeListener(new javax.swing.event.ChangeListener() {
					public void stateChanged(javax.swing.event.ChangeEvent evt) {
		...
		rbtnThresholdOperator1Cmb.setText(resourceMap
				.getString("rbtnThresholdOperator1Cmb.text")); // NOI18N
		rbtnThresholdOperator1Cmb.setName("rbtnThresholdOperator1Cmb"); // NOI18N

		txtThresholdOperator1.setText(resourceMap
				.getString("txtThresholdOperator1.text")); // NOI18N
		txtThresholdOperator1.setName("txtThresholdOperator1"); // NOI18N

		cmbRiskLevels.setName("cmbRiskLevels"); // NOI18N

		lblThresholdOperand2.setText(resourceMap
				.getString("lblThresholdOperand2.text")); // NOI18N
		...
		javax.swing.GroupLayout pnlThresholdSettingsLayout = new javax.swing.GroupLayout(
				pnlThresholdSettings);
		pnlThresholdSettings.setLayout(pnlThresholdSettingsLayout);
		pnlThresholdSettingsLayout
				.setHorizontalGroup(pnlThresholdSettingsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlThresholdSettingsLayout
																		...
																		.addGroup(
																				pnlThresholdSettingsLayout
																						.createParallelGroup(
																								javax.swing.GroupLayout.Alignment.TRAILING)
																						.addComponent(
																								cmbThresholdOperator1,
																								0,
																								148,
																								Short.MAX_VALUE)
																						.addComponent(
																								cmbThresholdOperator2,
																								0,
																								148,
																								Short.MAX_VALUE))))
										.addContainerGap()));
		pnlThresholdSettingsLayout
				.setVerticalGroup(pnlThresholdSettingsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlThresholdSettingsLayout
		...
		lblThresholdExpression.setFont(resourceMap
				.getFont("lblThresholdExpression.font")); // NOI18N
		lblThresholdExpression
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		lblThresholdExpression.setText(resourceMap
				.getString("lblThresholdExpression.text")); // NOI18N
		lblThresholdExpression.setName("lblThresholdExpression"); // NOI18N

		lblThresholdRiskLevel.setFont(resourceMap
				.getFont("lblThresholdRiskLevel.font")); // NOI18N
		lblThresholdRiskLevel
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		lblThresholdRiskLevel.setText(resourceMap
				.getString("lblThresholdRiskLevel.text")); // NOI18N
		lblThresholdRiskLevel.setName("lblThresholdRiskLevel"); // NOI18N

		javax.swing.GroupLayout pnlThresholdApproveLayout = new javax.swing.GroupLayout(
				pnlThresholdApprove);
		pnlThresholdApprove.setLayout(pnlThresholdApproveLayout);
		pnlThresholdApproveLayout
				.setHorizontalGroup(pnlThresholdApproveLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								pnlThresholdApproveLayout
										...
										.addContainerGap()));
		pnlThresholdApproveLayout
				.setVerticalGroup(pnlThresholdApproveLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlThresholdApproveLayout
		...
		pnlThresholdWizardHeader.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		...
		javax.swing.GroupLayout pnlThresholdWizardHeaderLayout = new javax.swing.GroupLayout(
				pnlThresholdWizardHeader);
		pnlThresholdWizardHeader.setLayout(pnlThresholdWizardHeaderLayout);
		pnlThresholdWizardHeaderLayout
				.setHorizontalGroup(pnlThresholdWizardHeaderLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlThresholdWizardHeaderLayout
										...
										.addContainerGap().addComponent(
												jLabel17).addContainerGap(215,
												Short.MAX_VALUE)));
		pnlThresholdWizardHeaderLayout
				.setVerticalGroup(pnlThresholdWizardHeaderLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								pnlThresholdWizardHeaderLayout
										...
										.addContainerGap(
												...
												jLabel17).addContainerGap()));

		pnlThresholdWizardButtons.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		pnlThresholdWizardButtons.setName("pnlThresholdWizardButtons"); // NOI18N

		btnThresholdWizardBack.setAction(actionMap
				.get("thresholdWizardBackButton")); // NOI18N
		btnThresholdWizardBack.setText(resourceMap
				.getString("btnThresholdWizardBack.text")); // NOI18N
		btnThresholdWizardBack.setName("btnThresholdWizardBack"); // NOI18N

		btnThresholdWizardNext.setAction(actionMap
				.get("thresholdWizardNextButton")); // NOI18N
		btnThresholdWizardNext.setText(resourceMap
				.getString("btnThresholdWizardNext.text")); // NOI18N
		btnThresholdWizardNext.setName("btnThresholdWizardNext"); // NOI18N

		btnThresholdWizardCancel.setAction(actionMap
				.get("closeThresholdWizardDialog")); // NOI18N
		btnThresholdWizardCancel.setText(resourceMap
				.getString("btnThresholdWizardCancel.text")); // NOI18N
		btnThresholdWizardCancel.setName("btnThresholdWizardCancel"); // NOI18N

		javax.swing.GroupLayout pnlThresholdWizardButtonsLayout = new javax.swing.GroupLayout(
				pnlThresholdWizardButtons);
		pnlThresholdWizardButtons.setLayout(pnlThresholdWizardButtonsLayout);
		pnlThresholdWizardButtonsLayout
				.setHorizontalGroup(pnlThresholdWizardButtonsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								pnlThresholdWizardButtonsLayout
										...
										.addGap(18, 18, 18).addComponent(
												btnThresholdWizardCancel)
										.addContainerGap()));
		pnlThresholdWizardButtonsLayout
				.setVerticalGroup(pnlThresholdWizardButtonsLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlThresholdWizardButtonsLayout
		...
		javax.swing.GroupLayout pnlthresholdWizardMainLayout = new javax.swing.GroupLayout(
				pnlthresholdWizardMain);
		pnlthresholdWizardMain.setLayout(pnlthresholdWizardMainLayout);
		pnlthresholdWizardMainLayout
				.setHorizontalGroup(pnlthresholdWizardMainLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlthresholdWizardMainLayout
										...
										.addContainerGap()));
		pnlthresholdWizardMainLayout
				.setVerticalGroup(pnlthresholdWizardMainLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlthresholdWizardMainLayout
		...
		javax.swing.GroupLayout thresholdWizardDialogLayout = new javax.swing.GroupLayout(
				thresholdWizardDialog.getContentPane());
		thresholdWizardDialog.getContentPane().setLayout(
				thresholdWizardDialogLayout);
		thresholdWizardDialogLayout
				.setHorizontalGroup(thresholdWizardDialogLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(pnlthresholdWizardMain,
								javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE));
		thresholdWizardDialogLayout
				.setVerticalGroup(thresholdWizardDialogLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(pnlthresholdWizardMain,
								javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		filterWizardDialog.setTitle(resourceMap
				.getString("filterWizardDialog.title")); // NOI18N
		...
		pnlFilterHeader.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		...
		javax.swing.GroupLayout pnlFilterHeaderLayout = new javax.swing.GroupLayout(
				pnlFilterHeader);
		pnlFilterHeader.setLayout(pnlFilterHeaderLayout);
		pnlFilterHeaderLayout.setHorizontalGroup(pnlFilterHeaderLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						pnlFilterHeaderLayout.createSequentialGroup()
								.addContainerGap().addComponent(jLabel21,
										javax.swing.GroupLayout.PREFERRED_SIZE,
										120,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(258, Short.MAX_VALUE)));
		pnlFilterHeaderLayout.setVerticalGroup(pnlFilterHeaderLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						pnlFilterHeaderLayout.createSequentialGroup()
		...
		pnlFilterButtons.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		...
		javax.swing.GroupLayout pnlFilterButtonsLayout = new javax.swing.GroupLayout(
				pnlFilterButtons);
		pnlFilterButtons.setLayout(pnlFilterButtonsLayout);
		pnlFilterButtonsLayout.setHorizontalGroup(pnlFilterButtonsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						pnlFilterButtonsLayout.createSequentialGroup()
								.addContainerGap(235, Short.MAX_VALUE)
								.addComponent(btnApplyFilter)
								.addGap(18, 18, 18).addComponent(
										btnCancelFilter).addGap(11, 11, 11)));
		pnlFilterButtonsLayout.setVerticalGroup(pnlFilterButtonsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						pnlFilterButtonsLayout.createParallelGroup(
								javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnCancelFilter).addComponent(
										btnApplyFilter)));
		...
		btnTransferToFilter.setText(resourceMap
				.getString("btnTransferToFilter.text")); // NOI18N
		...
		btnTransferAllToFilter.setAction(actionMap
				.get("transferAllHeadersToFilter")); // NOI18N
		btnTransferAllToFilter.setText(resourceMap
				.getString("btnTransferAllToFilter.text")); // NOI18N
		btnTransferAllToFilter.setName("btnTransferAllToFilter"); // NOI18N

		btnTransferAllToLeft.setAction(actionMap
				.get("transferAllHeadersToLeft")); // NOI18N
		btnTransferAllToLeft.setText(resourceMap
				.getString("btnTransferAllToLeft.text")); // NOI18N
		btnTransferAllToLeft.setName("btnTransferAllToLeft"); // NOI18N

		javax.swing.GroupLayout pnlFilterMainLayout = new javax.swing.GroupLayout(
				pnlFilterMain);
		pnlFilterMain.setLayout(pnlFilterMainLayout);
		pnlFilterMainLayout
				.setHorizontalGroup(pnlFilterMainLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlFilterMainLayout
										...
										.addContainerGap()));
		pnlFilterMainLayout
				.setVerticalGroup(pnlFilterMainLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlFilterMainLayout
		...
		javax.swing.GroupLayout filterWizardDialogLayout = new javax.swing.GroupLayout(
				filterWizardDialog.getContentPane());
		filterWizardDialog.getContentPane().setLayout(filterWizardDialogLayout);
		filterWizardDialogLayout
				.setHorizontalGroup(filterWizardDialogLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								filterWizardDialogLayout
										...
										.addContainerGap()));
		filterWizardDialogLayout
				.setVerticalGroup(filterWizardDialogLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								filterWizardDialogLayout
